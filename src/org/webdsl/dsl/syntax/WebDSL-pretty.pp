[
   ...
   For                                -- V[ V is=2[ H[KW["for"] KW["("] _1 KW[":"] _2 KW["in"] _3 KW["where"] _4 KW["order"] KW["by"] _5 KW[")"] KW["{"] ] _6 ] KW["}"]],
   For.6:iter-star                    -- _1,
   ForWhereNoOrderBy                  -- V[ V is=2[ H[KW["for"] KW["("] _1 KW[":"] _2 KW["in"] _3 KW["where"] _4 KW[")"] KW["{"] ] _5 ] KW["}"]],
   ForWhereNoOrderBy.5:iter-star      -- _1,
   ForNoWhereOrderBy                  -- V[ V is=2[ H[KW["for"] KW["("] _1 KW[":"] _2 KW["in"] _3 KW["order"] KW["by"]  _4 KW[")"] KW["{"] ] _5 ] KW["}"]],
   ForNoWhereOrderBy.5:iter-star      -- _1,
   ForNoWhereNoOrderBy                -- V[ V is=2[ H[KW["for"] KW["("] _1 KW[":"] _2 KW["in"] _3 KW[")"] KW["{"] ] _4 ] KW["}"]],
   ForNoWhereNoOrderBy.4:iter-star    -- _1,

   ForAll                             -- V[ V is=2[ H[KW["for"] KW["("] _1 KW[":"] _2 KW["where"] _3 KW["order"] KW["by"] _4 KW[")"] KW["{"] ] _5 ] KW["}"]],
   ForAll.5:iter-star                 -- _1,
   ForAllWhereNoOrderBy               -- V[ V is=2[ H[KW["for"] KW["("] _1 KW[":"] _2 KW["where"] _3 KW[")"] KW["{"] ] _4 ] KW["}"]],
   ForAllWhereNoOrderBy.4:iter-star   -- _1,
   ForAllNoWhereOrderBy               -- V[ V is=2[ H[KW["for"] KW["("] _1 KW[":"] _2 KW["order"] KW["by"] _3 KW[")"] KW["{"] ] _4 ] KW["}"]],
   ForAllNoWhereOrderBy.4:iter-star   -- _1,
   ForAllNoWhereNoOrderBy             -- V[ V is=2[ H[KW["for"] KW["("] _1 KW[":"] _2 KW[")"] KW["{"] ] _3 ] KW["}"]],
   ForAllNoWhereNoOrderBy.3:iter-star -- _1,
   ...
   ForStmt                            -- V[H[KW["for"] KW["("] _1 KW[":"] _2 KW["in"] _3 KW["where"] _4 KW["order"] KW["by"] _5 KW[")"] KW["{"]] H is=2[_6] KW["}"]],
   ForStmt.6:iter-star                -- _1,
   ForStmtWhereNoOrderBy              -- V[H[KW["for"] KW["("] _1 KW[":"] _2 KW["in"] _3 KW["where"] _4 KW[")"] KW["{"]] H is=2[_5] KW["}"]],
   ForStmtWhereNoOrderBy.5:iter-star  -- _1,
   ForStmtNoWhereOrderBy              -- V[H[KW["for"] KW["("] _1 KW[":"] _2 KW["in"] _3 KW["order"] KW["by"]  _4 KW[")"] KW["{"]] H is=2[_5] KW["}"]],
   ForStmtNoWhereOrderBy.5:iter-star  -- _1,
   ForStmtNoWhereNoOrderBy            -- V[H[KW["for"] KW["("] _1 KW[":"] _2 KW["in"] _3 KW[")"] KW["{"]] H is=2[_4] KW["}"]],
   ForStmtNoWhereNoOrderBy.4:iter-star-- _1,
