...
%% Search
   ...
   QueryDef					 -- H hs=1 [_1 _2],
   Start                     -- H hs=1 [KW["start"] _1],
   MaxResults                -- H hs=1 [KW["limit"] _1],
   SortBy   	             -- H hs=1 [KW["sort"] KW["by"] _1],
   SortBy.1:iter-star        -- _1,
   ConstraintFilter          -- H hs=1 [KW["where"] _1],
   ...
   HighlightTags		     -- H hs=1 [KW["highlight"] _1 KW["for"] _2 KW["on"] _3 KW["surround with ("] _4 KW[","] _5 KW[")"] ],
   HighlightTags		     -- H hs=1 [KW["highlight"] _1 KW["for"] _2 KW["on"] _3 ],
   SearchResults		     -- H hs=1 [KW["get results("] _1 KW[")"] ],
   FacetResults		     	 -- H hs=1 [KW["get facets("] _1 KW[")"] ],
   SearchResultsSize		 -- H hs=1 [KW["get size("] _1 KW[")"] ],
   SearchTimeString		     -- H hs=1 [KW["get searchtime("] _1 KW[")"] ],
   SearchTimeMS		         -- H hs=1 [KW["get searchtimems("] _1 KW[")"] ],
   SearchTimeSec		     -- H hs=1 [KW["get searchtimesec("] _1 KW[")"] ],
   ...
   SuggestTerm				 -- H hs=1 [KW["matching"] _1],
