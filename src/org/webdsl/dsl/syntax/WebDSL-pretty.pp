[
   ...
   Case.2:iter-star                   -- _1,
   CaseAlt                            -- V[ V is=2[ H[ _1 "{"] _2 ] "}" ],
   CaseDefault                        -- V[ V is=2[ H[ KW["default"] "{"] _1 ] "}" ], 
  
   TemplateCase                       -- V[V is=2[ H[KW["case"] KW["("] _1 KW[")"] KW["{"]] _2] KW["}"]],
   TemplateCase.2:iter-star           -- _1,
   TemplateCaseAlt                    -- V[ V is=2[ H[ _1 "{"] _2 ] "}" ],
   TemplateCaseDefault                -- V[ V is=2[ H[ KW["default"] "{"] _1 ] "}" ], 
