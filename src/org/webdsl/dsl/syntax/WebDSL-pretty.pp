[
   ...
   StyleDefinition                              -- _1 _2 KW["{"] _3 KW["}"],
   StyleDefinition.3:iter-star                  -- _1,
   StyleDefinition                              -- _1 _2 KW["{"] _3 KW["}"],
   StyleDefinition.3:iter-star                  -- _1,
   MatchDefinition                              -- _1 KW["("] _2 KW[")"],
   StyleVarDecl                                 -- KW["var"] _1 KW[":"] _2 KW[";"],
   StyleVarDeclInit                             -- KW["var"] _1 KW[":"] _2 KW[":="] _3 KW[";"],
   ...
   NamedLayoutExpression                        -- _1 KW["["] _2 KW["]"],
   LayoutExpressions                            -- _1,
   LayoutExpressions.1:iter-sep                 -- _1 KW["|"],
   LayoutExpression                             -- _1,
