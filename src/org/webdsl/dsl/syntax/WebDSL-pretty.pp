[
   ...
   IfNoElse                           -- V[H[KW["if"] _1 KW["then"]] _2 KW["end"]],
%%   For                                -- KW["for"] KW["("] _1 KW["in"] _2 KW["where"] _3 KW["ordered"] KW["by"] _4 KW["ascending"] KW[")"] _5,
   ForColl                            -- V[H[KW["for"] _1 KW[":"] _2 KW["in"] _3 KW["do"]] H is=2[_4] KW["end"]],
   ...
   EmptyListCreation                  -- H hs=0[KW["List"] KW["<"] H[_1] KW[">"] KW["("] KW[")"]],
   EmptySetCreation                   -- H hs=0[KW["Set"] KW["<"] H[_1] KW[">"] KW["("] KW[")"]],
