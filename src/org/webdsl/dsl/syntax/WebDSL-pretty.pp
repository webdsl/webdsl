[
   ...
   RequestScopeTemplateVarDeclInit         -- H[KW["request var"] _1 KW[":"] _2 KW[":="] _3],
   RequestScopeTemplateVarDeclInitInferred -- H[KW["request var"] _1 KW[":="] _2],
   RequestScopeTemplateVarDecl             -- H[KW["request var"] _1 KW[":"] _2],
   ...
   TupleCreation                      -- H hs=0[KW["("] H[_1] KW[")"]],
   TupleCreation.1:iter-star-sep      -- H hs=0[_1 KW[","]],
   TupleSort                          -- H hs=0[KW["("] H[_1] KW[")"]],
   TupleSort.1:iter-star-sep          -- H hs=0[_1 KW[","]],
...
%% Webdsl-Regex
   ...
   Placeholder                                            -- V is=2[ H hs=1[ KW["placeholder"] H hs=0[ KW["<"] _1 KW[">"] ] _2 KW["{"] ] _3 ] KW["}"],
   Placeholder.3:iter-star                                -- _1,
   PlaceholderWithAjaxCall                                -- V is=2 [ H[ KW["placeholder"] H hs=0[ KW["<"] _1 KW[">"] ] _2 ] _3 ],
   ...
   For                                                    -- V is=2 [H hs=1[ H hs=0[KW["for"] KW["("]] H hs=0[_1 KW[":"]] _2 KW["in"] _3 _4 KW[")"] KW["{"]] _5 KW["}"] _6],
   For.5:iter-star                                        -- _1,
   ForNoFilter                                            -- V is=2 [H hs=1[KW["for"] KW["("] _1 KW[":"] _2 KW["in"] _3 KW[")"] KW["{"]] _4 KW["}"] _5],
   ForNoFilter.4:iter-star                                -- _1,
   ForAll                                                 -- V is=2[ H [ H hs=0[ KW["for"] KW["("] ] H hs=0[ _1 KW[":"] ] _2 _3 H hs=0[ KW[")"] KW["{"] ] ] _4 ] KW["}"] _5,
   ForAll.4:iter-star                                     -- _1,
   ForCount                                               -- V is=2[ H hs=1[ H hs=0[KW["for"] KW["("]] H hs=0[_1 KW[":"]] KW["Int"] KW["from"] _2 KW["to"] _3 KW[")"] KW["{"]] _4 KW["}"] _5],
   ...
   TypeDef                                                -- V is=2[ H hs=1[ KW["type"] _1 KW["{"] ] _2 ] KW["}"],
   ...
   SubmitElem                     -- V is=2[ KW["submit"] _1 H[ KW["["] _2 KW["]"] KW["{"] ] _3 ] KW["}"],
   ...
   DownloadLink                                           -- V is=2[ H[ KW["downloadlink"] _1 KW["["] _2 KW["]"] KW["{"] ] _3 KW["}"] ],
