[
   ...
   %%styling
   StyleDefinition                              -- KW["style"] _1 KW["{"] _2 KW["}"],
   StyleDefinition.1:iter-star                  -- _1,
   StyleDescription                             -- _1 _2 KW["("] _3 KW[")"] KW["{"] _4 KW["}"],
   StyleDescription.4:iter-star                 -- _1,
   MatchTemplateArgs                            -- _1,
   MatchTemplateArgs.1:iter-star-sep            -- _1 KW[","],
   StyleBody                                    -- _1,
   StyleBody.1:iter-star                        -- _1,
   StyleBody                                    -- _1,
   StyleDeclaration                             -- _1 KW["="] _2,
   HorLayoutDeclaration                         -- _1,
   HorLayoutDeclaration.1:iter-sep              -- _1 KW["|"],
   VertLayoutDeclaration                        -- _1,
   VertLayoutDeclaration.1:iter                 -- _1,
   StyleProperty                                -- _1,
   StyleValue                                   -- _1,
