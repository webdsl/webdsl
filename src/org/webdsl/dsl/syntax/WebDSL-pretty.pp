[
   ...
   Workflow                                     -- V[V is=2[H[KW["workflow"] _1 KW["("] _2 KW[")"] KW["{"]] _3 ] KW["}"]],
   ...
   WorkflowDone                                 -- V  [V is=2 [H [KW["done"] KW["{"]] _1] KW["}"]],
   WorkflowInit                                 -- KW["init"] KW["("] _1 KW[")"] _2,
   WorkflowInit.1:iter-star-sep                 -- H hs=0[_1 KW[","]],
   WorkflowInitNoArgs                           -- KW["init"] _1,
