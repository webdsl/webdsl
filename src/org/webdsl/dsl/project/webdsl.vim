...
syntax keyword webdslBlocks module application section description note procedures
syntax keyword webdslConditional for if else
syntax keyword webdslKeywords in return define var page email enum session entity extend predicate policy pointcut access control rules globals action function template where order by init goto auto procedure who when do view derive status done performed processed enabled
