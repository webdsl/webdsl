...
syntax keyword webdslKeywords in return define var page email enum session entity extend predicate policy pointcut access control rules globals action function template where order by init goto operation who when do view derive
syntax keyword webdslBuiltins true false this Bool String Int Float Bool Secret Email Text WikiText Date Time DateTime Patch Image File URL Set List inverse status
