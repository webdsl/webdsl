...
(defvar webdsl-keywords
  ...
  '("\\<a\\>"  "\\<action\\>"  "\\<application\\>"  "\\<as\\>"  "\\<define\\>"  "\\<description\\>"  "\\<else\\>"  "\\<end\\>"  "\\<entity\\>"  "\\<extend\\>"  "\\<false\\>"  "\\<for\\>"  "\\<function\\>"  "\\<globals\\>"  "\\<goto\\>"  "\\<if\\>"  "\\<imports\\>"  "\\<in\\>"  "\\<init\\>"  "\\<inverse\\>"  "\\<inverseSlave\\>"  "\\<is\\>"  "\\<List\\>"  "\\<module\\>"  "\\<note\\>"  "\\<null\\>"  "\\<page\\>"  "\\<return\\>"  "\\<rules\\>"  "\\<section\\>"  "\\<select\\>"  "\\<session\\>"  "\\<Set\\>"  "\\<true\\>"  "\\<var\\>"  "\\<where\\>" "\\<access\\>" "\\<control\\>" "\\<with\\>" "\\<template\\>" "\\<order\\>" "\\<by\\>" "\\<asc\\>" "\\<desc\\>" "\\<enum\\>" "\\<credentials\\>"
