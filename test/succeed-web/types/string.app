...
define ignore-access-control outputString1(s: String){
  text(s)
}

  define ignore-access-control inputString1(s:Ref<String>){
...
define ignore-access-control inputStringInternal(s : Ref<String>, tname : String){
  var req := getRequestParameter(tname)
  <input 
...
define test(e:Ent){ 
  ...
  form{
    ...
    label(" CLICK ")[class = "label-elem"]{
      inputString1(e.s)[class = "input-elem"]
    }
