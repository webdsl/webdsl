...
public class diff_match_patch {
  ...
  private int Match_MaxBits = 32;
    ...
    public String patchMake(String s1, String s2) {
	return patch_toText(patch_make(s1, s2));
    }

    public String patchApply(String patch, String s) {
	LinkedList<Patch> patches = (LinkedList<Patch>)patch_fromText(patch);
	return (String)(patch_apply(patches, s)[0]);
    }
...
public LinkedList<Diff> diff_compute(String text1, String text2,
   ...
   * @return Array of diff tuples or null if text1 is wrong length
   */
