...
{ 
  ...
  { 
    try
    { 
      InputStream descriptorStream = NwlParseController.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = NwlParseController.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(NwlParseController.class);
    }
  ...
  { 
    return NwlParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
