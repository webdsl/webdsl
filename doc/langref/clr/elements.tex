...
%   "*"  MDProps?	TemplateElement		-> TemplateElement{cons("MDListItem")}
	\item[* attrs? element]\ii{*}\ii{listitem} shorthand for a \e{listitem} with one child
...
%   "<"  MDProps? MDCol* ">" 			-> TemplateElement{cons("MDRow")}
	\item[$<$ attrs? ($|$ element*)* $>$]\ii{$<|$ \ldots $>$}\ii{$|$}\ii{row}\ii{column} shorthand for \e{row} with \e{column}'s (seperated by "$|$") in it. Can also be used instead of \e{groupitem} in groups. 
