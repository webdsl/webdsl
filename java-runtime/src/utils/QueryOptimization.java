...
public class QueryOptimization {
	public static org.hibernate.Criteria addQueryOptimization(org.hibernate.Criteria criteria, Object joinstr, Object criterion) {
		//System.out.println("addQueryOptimization");
		//System.out.println("joinstr: " + joinstr);
		//System.out.println("criterion: " + criterion);
		org.hibernate.Criteria ret = criteria;
		String[] joins = ((String)joinstr).split("\\|");
