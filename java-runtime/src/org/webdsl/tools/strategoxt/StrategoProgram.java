...
public class StrategoProgram {
    ...
    public static synchronized StrategoProgram get(String programName) {
        return get(programName,utils.ApplicationContextProperty.class);
    }
    ...
    public static synchronized StrategoProgram get(String programName, Class<?> ownerClass) {
        try {
            StrategoProgram result = getProgram(programName);
            if (result == null) {
    ...
    private static synchronized StrategoProgram getProgram(String programName) {
