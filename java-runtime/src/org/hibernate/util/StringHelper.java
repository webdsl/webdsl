...
public final class StringHelper {
  ...
  static {
    // Patched inefficient method `firstIndexOfChar` - see https://github.com/hibernate/hibernate-orm/commit/8998b4154a6000b468e4b3432a2febdd1423a150
    // hibernate-core-3.6.10 jar has been patched (and renamed to hibernate-core-3.6.10-patched.jar) by replacing the StringHelper class with this patched class
    Logger.info( "Using performance-patched class definition for org.hibernate.util.StringHelper" );
  }
