...
public class TestQueryList {
  public static void testHibernate() {
    ...
    Query query = hibSession.createQuery("from Message item where "
        + and(eq("author", zef), neq("author.age", 50)).toHQL(bindings));
  ...
  private static void testLocal() {
    ...
    List<Object> bindings = new ArrayList<Object>();
    System.out.println(and(eq("author", zef), neq("author.age", 50)).toHQL(bindings));
